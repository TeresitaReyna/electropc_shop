		...
		<div class="row">
			<div class="col-md-6 col-sm-4 col-lg-4">
				<div class="info-box">
					<div class="row">
						...
						<div class="col-xs-10">
							<h4 class="info-box-heading green">Devolución</h4>
						</div>
					</div>	
					<h6 class="text">Garantía de devolución de 30 días.</h6>
				</div>
			</div><!-- .col -->
			...
			<div class="hidden-md col-sm-4 col-lg-4">
				<div class="info-box">
					...
					<h6 class="text">Envio gratis en compras mayores de $ 600.00</h6>	
				</div>
			</div><!-- .col -->
